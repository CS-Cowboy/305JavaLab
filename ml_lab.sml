...
(*Use foldr to apply g to all elements of e. ~~Jacob*)

fun isMember e = foldr(fn g => (hd e = hd(tl e)));

fun list2Set z = if (isMember (hd z) = false) then let fun h = Set(hd z, list2Set (tl z));
